...
public class RvAdapter extends RecyclerView.Adapter<RvAdapter.RvViewHolder> {
    ...
    public void onBindViewHolder(RvViewHolder rvViewHolder, int position) {
        rvViewHolder.codigo.setText(quote.get(0).getSymbol().toString());
        rvViewHolder.empresa.setText(quote.get(0).getName().toString());
        rvViewHolder.cotacao.setText(quote.get(0).getLastTradePriceOnly().toString());
    }
